...
/**
 * Downloads a Steam Workshop mod through SteamCMD, following the same pattern
 * as {@link TaskModDownload}. With profile MANUAL the downloaded content stays
 * in the SteamCMD Workshop cache, with AUTOMATIC it is copied back into the
 * existing mod directory.
 */
